...
sys.path.append("third_lib/sqlmap")
sys.path.append("third_lib/fastapi")
sys.path.append("third_lib/psutil")
...
from third_lib.sqlmap.lib.core.common import getUnicode
...
from third_lib.sqlmap.lib.core.settings import RESTAPI_DEFAULT_ADAPTER
from third_lib.sqlmap.lib.core.settings import RESTAPI_DEFAULT_ADDRESS
from third_lib.sqlmap.lib.core.settings import RESTAPI_DEFAULT_PORT
